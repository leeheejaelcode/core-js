...
const value = sum; // 함수 본문을 전달하면 변수를 함수처럼 실행이 가능하다
...
/* 클로저란 
함수는 태어난 환경을 기억합니다.
가비지 컬렉터는 함수의 실행이 끝나면 모든 메모리를 수거해 갑니다.
함수의 변수를 기억하기 위해 클로저를 사용합니다.
클로저란 내부 함수가 외부 변수에 대한 참조를 할 수 있는 환경을 제공해주는 함수 입니다.
*/
